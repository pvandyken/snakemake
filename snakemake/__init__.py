...
def get_argument_parser(profile=None):
    ...
    group_utils.add_argument(
        "--list-tracked",
        action="store_true",
        help="List all files in the working directory that are used in the  "
        "workflow.",
    )
    group_utils.add_argument(
        "--get-metadata",
        ...
        nargs="+",
        metavar="FILE",
        help="List metadata files associated with given outputs",
    )
    group_utils.add_argument(
        "--delete-all-output",
        action="store_true",
...
def main(argv=None):
    ...
    if args.gui is not None:
        ...
        success = snakemake(
            ...
            list_tracked=args.list_tracked,
